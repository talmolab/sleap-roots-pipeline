...
Then A4 (needs A0 + A2 + A3), gated operationally on **1 scoped Supabase credential** ([#17](https://github.com/talmolab/sleap-roots-pipeline/issues/17)) — the firewall/connectivity half ([#16](https://github.com/talmolab/sleap-roots-pipeline/issues/16)) resolved 2026-07-21.
