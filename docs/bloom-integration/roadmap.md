...
| **traits wiring** | wire A3-traits (emits `ResultEnvelope`) into the workflow | EPIC #9 → #11 | ⬜ (A3-traits emitter ✅ merged [#254](https://github.com/talmolab/sleap-roots/pull/254); GHCR **trait-extractor image** in progress — sleap-roots [#256](https://github.com/talmolab/sleap-roots/issues/256) / `add-trait-extractor-image`; then wire the Argo template) |
